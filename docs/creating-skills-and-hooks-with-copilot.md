...
2. **Use GitHub Copilot** — We created all 10 skills and 18 hooks in this repo using [GitHub Copilot CLI](https://githubnext.com/projects/copilot-cli). You can do the same in your IDE, the CLI, or on GitHub.com.
...
We created all 10 skills and 18 hooks in this repo using [GitHub Copilot CLI](https://githubnext.com/projects/copilot-cli). Here's how you can do the same — whether you're using Copilot in your IDE, the CLI, or on GitHub.com.
...
Then read the existing SKILL.md files in plugins/vm-sre-skills/skills/ in this repo to understand the
...
Follow the same format as the other README.md files in plugins/vm-sre-skills/skills/. Include:
