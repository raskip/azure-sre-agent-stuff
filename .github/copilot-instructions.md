...
| Directory | Contents |
|-----------|----------|
| `plugins/vm-sre-skills/skills/` | 10 VM troubleshooting skills (SKILL.md + testing README per skill) |
| `hooks/` | 18 governance hook examples (YAML) + comprehensive guide |
...
Each skill lives in its own directory under `plugins/vm-sre-skills/skills/<skill-name>/`:
