...
| **Skills loaded** | All 10 VM skills added to the agent (see [How to add skills](../../skills/README.md#how-to-add-a-skill-to-your-agent)) |
...
|---|-------|------|-------------|
| 1 | [`disk-expansion`](skills/disk-expansion/) | Remediation | Expand VM disks when space is low |
| 2 | [`high-cpu-vm-troubleshooting`](skills/high-cpu-vm-troubleshooting/) | Diagnostic | Diagnose high CPU — top processes, per-core breakdown |
| 3 | [`high-memory-oom-troubleshooting`](skills/high-memory-oom-troubleshooting/) | Diagnostic | Diagnose memory pressure, swap, OOM kills |
| 4 | [`vm-connectivity-troubleshooting`](skills/vm-connectivity-troubleshooting/) | Diagnostic | Diagnose SSH/RDP failures — NSGs, routes, OS firewall |
| 5 | [`service-crash-loop-detection`](skills/service-crash-loop-detection/) | Diagnostic | Investigate services that keep crashing |
| 6 | [`security-incident-triage`](skills/security-incident-triage/) | Diagnostic | Triage brute-force attempts, rogue processes, open ports |
| 7 | [`vm-right-sizing`](skills/vm-right-sizing/) | Advisory | Analyze utilization and recommend optimal VM SKU |
| 8 | [`backup-health-verification`](skills/backup-health-verification/) | Diagnostic | Verify Azure Backup config, recovery points, failed jobs |
| 9 | [`vm-extension-failure-remediation`](skills/vm-extension-failure-remediation/) | Remediation | Diagnose and fix failed VM extensions |
| 10 | [`disk-iops-throttling`](skills/disk-iops-throttling/) | Diagnostic | Investigate disk IOPS/throughput throttling |
...
- [disk-expansion/README.md](skills/disk-expansion/) — VM with a nearly-full disk
- [high-cpu-vm-troubleshooting/README.md](skills/high-cpu-vm-troubleshooting/) — VM running a CPU stress test
- [high-memory-oom-troubleshooting/README.md](skills/high-memory-oom-troubleshooting/) — VM under memory pressure
- [vm-connectivity-troubleshooting/README.md](skills/vm-connectivity-troubleshooting/) — VM with blocked SSH/RDP
- [service-crash-loop-detection/README.md](skills/service-crash-loop-detection/) — VM with a crashing service
- [security-incident-triage/README.md](skills/security-incident-triage/) — VM with simulated security events
- [vm-right-sizing/README.md](skills/vm-right-sizing/) — Over-provisioned VM with low utilization
- [backup-health-verification/README.md](skills/backup-health-verification/) — VM with Azure Backup configured
- [vm-extension-failure-remediation/README.md](skills/vm-extension-failure-remediation/) — VM with a failed extension
- [disk-iops-throttling/README.md](skills/disk-iops-throttling/) — VM with disk-intensive workload
...
1. **Create a folder** — `plugins/vm-sre-skills/skills/<your-skill-name>/`
2. **Write `SKILL.md`** — The prompt the agent will use. Follow the [key principles](../../skills/README.md#how-to-write-new-skills).
