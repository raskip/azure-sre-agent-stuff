...
examples:
  - "Diagnose which disk is full on vm-app-001"
  - "Expand the data disk on vm-prod-web-01 safely"
  - "Check if OS disk growth needs downtime for vm-db-01"
  - "Verify partition and filesystem expanded after resizing vm-files-01"
---
