...
examples:
  - "Assess whether vm-app-001 is oversized or undersized"
  - "Find right-sizing candidates across VMs in rg-prod"
  - "Explain whether vm-db-01 needs compute, memory, or IO headroom"
  - "Report a resize recommendation and risks for vm-prod-web-01"
---
