...
examples:
  - "Investigate disk throttling on vm-db-01 in rg-backend"
  - "Find VMs in rg-prod hitting disk IOPS limits"
  - "Explain whether vm-app-001 is disk-bound or VM-bound"
  - "Report top latency, queue, and throughput signals for vm-files-01"
---
