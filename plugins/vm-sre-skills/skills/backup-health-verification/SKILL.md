...
examples:
  - "Investigate backup health for vm-prod-web-01 in rg-prod"
  - "Find VMs in rg-backend missing backup protection"
  - "Check whether vm-app-001 meets our backup RPO"
  - "Report recent backup failures and recovery points for vm-db-01"
---
