...
examples:
  - "Investigate sustained CPU spikes on vm-prod-web-01"
  - "Find high-CPU VMs across rg-prod and rg-backend"
  - "Explain whether vm-app-001 is compute-bound or IO-wait"
  - "Report top CPU processes and recent changes on vm-batch-01"
---
