...
**Why this works:** Every organization has oversized VMs. Showing the agent find one with actual numbers and estimated savings makes the ROI conversation trivial. This is the scenario that builds the cost-savings case.
...
| Step | What the agent does | What to highlight |
|------|---------------------|---------------------------|
...
> *"Now multiply that by the number of VMs in your environment. Teams typically see 20–40% savings on compute costs just by right-sizing."*
